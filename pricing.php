...
<div class="container">
    <div class="card">
        <div class="plan">
            <div class="bhumi">
                <h1>Bihar Bhumi Seva Membership Plans</h1>
                <p>Join us and be a part of the mission to empower Bihar's land services.</p>
            </div>
            <div class="row mt-4">
                <div class="col-md-3">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <ul>
                    ...
                    <a href="<?= base_url('buy-plan.php?plan=2'); ?>" class=" btn btn-primary mt-4">Pay Now</a>
                </ul>
            </div>
        </div>
    </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <ul>
                    ...
                    <a href="<?= base_url('buy-plan.php?plan=5') ?>" class="btn btn-primary mt-4">Pay Now</a>
                </ul>
            </div>
        </div>
    </div>
